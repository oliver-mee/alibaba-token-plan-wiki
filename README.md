...
| [Project learnings](LEARNINGS.md) | Public lessons about evidence, entitlement, promotions, and catalogue hygiene |
...
- `/models` lists 25 ids per Team key: 19 chat + 4 image + 1 TTS + 1 realtime
